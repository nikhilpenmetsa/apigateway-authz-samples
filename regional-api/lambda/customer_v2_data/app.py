...
def lambda_handler(event, context):
    """
    Lambda handler for customer V2 data operations with Cognito authorizer
    """
    try:
        ...
        # When using Cognito authorizer, user claims are available in the requestContext
        request_context = event.get('requestContext', {})
        authorizer = request_context.get('authorizer', {})
        
        # Log the authorizer context for debugging
        print(f"Authorizer context: {json.dumps(authorizer)}")
        ...
        # Handle PUT request - create or update customer data
            ...
            item = {
                ...
                'version': 'v2'  # Add version marker to distinguish from v1
            }
            ...
            return build_response(200, {
                'message': 'Customer data saved successfully (V2)',
                'customerId': customer_id
            })
